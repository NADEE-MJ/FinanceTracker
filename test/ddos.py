...
class ReuqestThread(threading.Thread):
    ...
    def run(self):
        ...
        print(get_request(self.base, self.params).json())
...
def main():
    ...
    user = TestUser('ddospassword', 'ddospassword', 'ddosemail@email.com', 'ddosusername')
